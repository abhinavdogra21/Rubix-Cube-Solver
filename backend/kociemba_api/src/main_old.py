...
try:
    from enhanced_kociemba_solver import (
        solve_cube, solve_scramble, generate_scramble, is_valid_cube, 
        scramble_to_cube_string, clear_session, get_session_info
    )
    KOCIEMBA_AVAILABLE = True
    print("Enhanced Kociemba solver loaded successfully")
except ImportError as e:
    print(f"Warning: Could not import Enhanced Kociemba solver: {e}")
